...
public class DBlegsa extends SQLiteOpenHelper {

    public static final String TAG = DBlegsa.class.getSimpleName();
    public static final String DB_n = "dblegsa.db";
    ...
    public DBlegsa(Context context) {
