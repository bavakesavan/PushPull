...
public class DBlegsb extends SQLiteOpenHelper {

    public static final String TAG = DBlegsb.class.getSimpleName();
    public static final String DB_n = "dblegsb.db";
    ...
    public DBlegsb(Context context) {
