...
public class set1 extends SQLiteOpenHelper {

    public static final String TAG = set1.class.getSimpleName();
    public static final String DB_n = "set11.db";
