...
public class set6 extends SQLiteOpenHelper {

    public static final String TAG = set6.class.getSimpleName();
    public static final String DB_n = "set61.db";
