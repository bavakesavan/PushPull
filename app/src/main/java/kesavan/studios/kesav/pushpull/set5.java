...
public class set5 extends SQLiteOpenHelper {

    public static final String TAG = set5.class.getSimpleName();
    public static final String DB_n = "set51.db";
