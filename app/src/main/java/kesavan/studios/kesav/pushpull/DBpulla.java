...
public class DBpulla extends SQLiteOpenHelper {

    public static final String TAG = DBpulla.class.getSimpleName();
    public static final String DB_n = "dbpulla.db";
    ...
    public static final String COLUMN_7 = "pushaw7";
    ...
    public DBpulla(Context context) {
