...
public class DBmainold extends SQLiteOpenHelper {

    public static final String TAG = DBmainold.class.getSimpleName();
    public static final String DB_n = "dbmainuser.db";
    ...
    public DBmainold(Context context) {
