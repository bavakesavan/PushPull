...
public class DBpushb extends SQLiteOpenHelper {

    public static final String TAG = DBpushb.class.getSimpleName();
    public static final String DB_n = "dbpushb.db";
    ...
    public DBpushb(Context context) {
