...
public class DBrating extends SQLiteOpenHelper {

    public static final String TAG = DBrating.class.getSimpleName();
    public static final String DB_n = "Shorttext0.db";
    public static final int DB_VERSION = 2;

    public static final String USER_TABLE = "shorttexts";
    ...
    public DBrating(Context context) {
