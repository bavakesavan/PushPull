...
public class set2 extends SQLiteOpenHelper {

    public static final String TAG = set2.class.getSimpleName();
    public static final String DB_n = "set21.db";
