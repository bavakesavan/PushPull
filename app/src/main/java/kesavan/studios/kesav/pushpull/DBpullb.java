...
public class DBpullb extends SQLiteOpenHelper {

    public static final String TAG = DBpullb.class.getSimpleName();
    public static final String DB_n = "dbpullb.db";
    ...
    public DBpullb(Context context) {
